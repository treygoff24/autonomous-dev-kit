...
- **Agent-team terminology alignment** across protocol and skill docs
  - Updated `CLAUDE.md`, `AUTONOMOUS_BUILD_CLAUDE.md`, and templates to use agent-team wording (with explicit mapping to Claude Task API terms where needed)
  - Updated `skills/orchestrator/SKILL.md` and `skills/requesting-code-review/SKILL.md` to remove ambiguous "subagent-driven" phrasing

- **Task-builder completion contract tightened**
  - `agents/task-builder.md` and `skills/task-builder/SKILL.md` now require quality gates before marking tasks `completed`

- **Autonomous loop completion criteria clarified**
  - `skills/autonomous-loop/SKILL.md` now documents task list precedence and quality-gate execution order
  - `skills/claude/SKILL.md` now explicitly documents deterministic Stop hook enforcement
  - `tests/test-integration.sh` updated to match current completion semantics
